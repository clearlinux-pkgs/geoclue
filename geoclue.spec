...
Source0  : https://gitlab.freedesktop.org/geoclue/geoclue/-/archive/2.5.7/geoclue-2.5.7.tar.gz
...
%prep
%setup -q -n geoclue-2.5.7
cd %{_builddir}/geoclue-2.5.7
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610128761
...
cp %{_builddir}/geoclue-2.5.7/COPYING %{buildroot}/usr/share/package-licenses/geoclue/9f36ee7d499d8aacee2830333120c184f7d0cef9
cp %{_builddir}/geoclue-2.5.7/COPYING.LIB %{buildroot}/usr/share/package-licenses/geoclue/3ab14ae755fcd87385b7dc685e7e3dfb803b90b4
