...
Version  : 2.4.9
Release  : 10
URL      : https://www.freedesktop.org/software/geoclue/releases/2.4/geoclue-2.4.9.tar.xz
Source0  : https://www.freedesktop.org/software/geoclue/releases/2.4/geoclue-2.4.9.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1525319973
export AR=gcc-ar
